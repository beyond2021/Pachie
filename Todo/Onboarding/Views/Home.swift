    ...
    var body: some View {
        GeometryReader {
            ...
            IntroView(intro: $activeIntro, size: size) {
                ...
                VStack(spacing: 10) {
                    /// Custom TextField
                    CustomTextField2(text: $emailID, hint: "Email Address", leadingIcon: Image(systemName: "envelope"))
                    CustomTextField2(text: $emailID, hint: "Password", leadingIcon: Image(systemName: "lock"), isPassword: true)
